...
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Form Edit Email Template</h4>
                ...
                <form name="formcreate" action="{{url('/template-email/update/'.$template_email->id)}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                    @csrf

                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="inputEmail4" class="col-form-label">Title <a style="color: red">*</a></label>
                            <input value="{{$template_email->title}}" name="title" id="title" type="text" class="form-control" placeholder="Email Title">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputEmail4" class="col-form-label">Banner <a style="color: red">*</a></label>
                            <img src="{{asset('BannerEmail/'.$template_email->banner)}}" style="margin-bottom: 30px" id="gambar_nodin" width="300"/>
                            <input type="file" name="file_banner" id="file_banner" class="form-control-file">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="inputEmail4" class="col-form-label">Voucher Code <a style="color: red">*</a></label>
                            <input value="{{$template_email->voucher}}" name="voucher" id="voucher" type="text" class="form-control" placeholder="Voucher Code">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="inputEmail4" class="col-form-label">Promo Link <a style="color: red">*</a></label>
                            <input value="{{$template_email->link}}" name="link" id="link" type="text" class="form-control" placeholder="Promo Link">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                            <label for="inputEmail4" class="col-form-label">Description</label>
                            <textarea name="description" id="summernote-editor"> {!! $template_email->description !!} </textarea>
                        </div><!-- end col -->
                    </div>
